                ...
                <div class="card-body">
                    <form action="<?= base_url('checkout/create') ?>" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="" class="form-control" placeholder="Nama Penerima" value="<?= $input->name ?>">
                            <?= form_error('name'); ?>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="phone" id="" class="form-control" placeholder="Telepon Penerima" value="<?= $input->phone ?>">
                            <?= form_error('phone'); ?>
                        </div>
