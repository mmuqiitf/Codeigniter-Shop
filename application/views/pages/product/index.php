                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?= $no; ?></td>
                                    <td>
                                        <p><img src="<?= $row->image ? base_url("/images/product/$row->image") : 'http://placehold.co/70x70';  ?>" alt="" width="70" height="70"> <?= $row->product_title; ?> </p>
                                    </td>
                                    <td><span class="badge badge-primary"><i class="fas fa-tags"></i> <?= $row->category_title; ?> </span>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                        <a href="<?= base_url("product/edit/$row->id") ?>" class="">
